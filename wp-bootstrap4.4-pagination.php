...
function bootstrap_pagination( \WP_Query $wp_query = null, $echo = true, $params = [] ) {
    ...
    if ( is_array( $pages ) ) {
        ...
        $pagination = '<div class="pagination"><ul class="pagination mx-auto d-flex align-items-center justify-content-center ">';

        foreach ( $pages as $page ) {
            $pagination .= '<li class="page-item py-0' . (strpos($page, 'current') !== false ? ' active' : '') . '"> ' . str_replace('page-numbers', 'page-link', $page) . '</li>';
        }
